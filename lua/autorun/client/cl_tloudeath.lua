...
hook.Add( "PopulateToolMenu", "CustomMenuSettings", function()
	spawnmenu.AddToolMenuOption( "Options", "tlou_deathscreen_config", "deathscreen_general", "#General", "", "", function( panel )
		panel:ClearControls()
		panel:NumSlider( "Gravity", "sv_gravity", 0, 600 )
	end )
	spawnmenu.AddToolMenuOption( "Options", "tlou_deathscreen_config", "deathscreen_hints", "#Hints", "", "", function( panel )
		panel:ClearControls()
		panel:CheckBox("Enable hints?","tloudeath_hints")
	end )
end )