...
hook.Add("AddToolMenuCategories", "CustomCategory", function()
	spawnmenu.AddToolCategory("Options", "tlou_deathscreen_config", "#TLOU Death Screen")
end )
...
hook.Add( "PopulateToolMenu", "CustomMenuSettings", function()
	spawnmenu.AddToolMenuOption( "Options", "tlou_deathscreen_config", "deathscreen_general", "#General", "", "", function( dform )
		...
		dform:ControlHelp("Enable sound DSP (Underwater effect) on blackout?")
		dform:CheckBox("Enable post-processing?", "tloudeath_postprocess")
		dform:ControlHelp("Enable post processing effects?")
	end )

	spawnmenu.AddToolMenuOption( "Options", "tlou_deathscreen_config", "deathscreen_hints", "#Hints", "", "", function( dform )
		dform:ClearControls()
		dform:CheckBox("Enable hints?","tloudeath_hints")
		local hinttype = dform:ComboBox("Hints mode", "tloudeath_hints_mode")
		hinttype:SetSortItems(false)
		hinttype:AddChoice("TLOU", 1)
		hinttype:AddChoice("TLOU2", 2)
		dform:ControlHelp("Change type of hints shown")
	end )
end )